...
public class ServerFacadeTests {
    ...
    final MemoryAuthDAO authDAO = MemoryAuthDAO.getInstance();
    final MemoryGameDAO gameDAO = MemoryGameDAO.getInstance();
    final MemoryUserDAO userDAO = MemoryUserDAO.getInstance();
