...
public class ChessPiece {
    ...
    public class MovesStrategyFactory {
        public static PieceMovesStrategy getStrategy(PieceType type) {
            return switch (type) {
    ...
    public static class PawnMovesStrategy implements PieceMovesStrategy {
    ...
    public static class KnightMovesStrategy implements PieceMovesStrategy {
    ...
    public static class BishopMovesStrategy implements PieceMovesStrategy {
    ...
    public static class RookMovesStrategy implements PieceMovesStrategy {
    ...
    public static class QueenMovesStrategy implements PieceMovesStrategy {
    ...
    public static class KingMovesStrategy implements PieceMovesStrategy {
